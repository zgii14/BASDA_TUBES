                ...
                <div class="x_panel">
                            ...
                            ?>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            Nama Peminjam
                                            <input type="text" class="form-control" placeholder="nama peminjam" value="<?php echo ($nama_peminjam); ?>" name="nama_peminjam" disabled required>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            banyaknya
                                            <input type="text" class="form-control" placeholder="Banyaknya" value="<?php echo ($banyaknya); ?>" name="banyaknya" disabled required>
                                        </td>
                                    </tr>
                    ...
                    <?php
                            ...
                            if (isset($_POST["submit3"])) {
                                ...
                                // Fetching data of the borrowed item
                                $res5 = mysqli_query($link, "SELECT peminjaman.*, tambah_barang.* FROM peminjaman INNER JOIN tambah_barang ON peminjaman.kode_barang=tambah_barang.kode_barang WHERE no_peminjaman='$_POST[kode]'");
                                while ($row5 = mysqli_fetch_array($res5)) {
                                    $no_peminjaman = $row5["no_peminjaman"];
                                    $nama_peminjam = $row5["nama_peminjam"];
                                ...
                                mysqli_query($link, "INSERT INTO history (no_peminjaman, nama_peminjam, tgl_peminjaman, tgl_pengembalian, kode_barang, banyaknya, status) VALUES ('$no_peminjaman', '$nama_peminjam', '$tgl_peminjaman', '$date', '$kode_barang', '$banyaknya', 'Sudah Dikembalikan')");

                                // Return the items to the tambah_barang table
