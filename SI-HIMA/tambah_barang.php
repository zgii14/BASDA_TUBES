                        ...
                        <div class="login_wrapper">
                            ...
                            <section class="login_content" style="margin-top: -40px;">
                                <form name="form1" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div>
                                        <input type="number" class="form-control" placeholder="Jumlah Barang" name="jumlah_barang" required="" />
                                    </div>
                            ...
                            if (isset($_POST["submit1"])) {
                                ...
                                mysqli_query($link, "insert into tambah_barang (kategori, nama_barang, jumlah_barang, sinopsis, gambar_barang) values('$_POST[kategori]','$_POST[nama_barang]','$_POST[jumlah_barang]','$_POST[sinopsis]','$dst1')");
                            ?>
